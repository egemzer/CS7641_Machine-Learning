...
problem = KnapsackGenerator.generate(seed=random.seed(17), number_of_items_types=35, max_item_count=20,
										 max_weight_per_item=5, max_value_per_item=5,max_weight_pct=0.6)
